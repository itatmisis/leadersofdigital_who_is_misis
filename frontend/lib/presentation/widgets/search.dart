...
class Search extends StatefulWidget {
  ...
  const Search.v1({super.key, this.onSubmitted})
      : _backgroundColor = AppColors.white,
        _elevation = 3;

  const Search.v2({super.key, this.onSubmitted})
      : _backgroundColor = AppColors.neutral200,
        _elevation = 3;

  const Search.v3({super.key, this.onSubmitted})
      : _backgroundColor = AppColors.neutral100,
        _elevation = 1;
      ...
      child: Material(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
              ...
              hintStyle:
                  AppFonts.body1Regular.copyWith(color: AppColors.lightGray),
              prefixIcon: Padding(
                padding: const EdgeInsets.only(
                    right: 15, top: 12, bottom: 12, left: 15),
